...
# sys.path.extend(['D:\\github\\music-recommendation-system\\python-django\\movieSystem', ])
os.environ.setdefault("DJANGO_SETTINGS_MODULE", "musicrecomend.settings")
...
def get_url_movie():
    ...
    while urls:
        ...
        for movie_href in movie_hrefs:
            print('fetch music href', movie_href)
